  ...
  render() {
    ...
    return (
      <>
        ...
        <div className="mahe">Created by Mahesh</div>
      </>
    );
  }
}
  ...
  render() {
    ...
    return (
      <div>
        ...
        <button className="new-quote-button" onClick={this.props.handleClick}>
          new quote
        </button>{" "}
        <a href={this.createTweetLink()} target="_blank" id="tweet-quote" className="bird">
